...
class TestParser(unittest.TestCase):
    ...
    def test_flow_control(self):
        ...
        self.run_test("[LF][Space][Tab][Tab][Space][Space][LF]", [CallSub(1, -1, 4)])
        self.run_test("[LF][Tab][Space][Tab][Tab][Tab][LF]", [JumpZero(1, -1, 7)])
        self.run_test("[LF][Tab][Tab][Tab][Tab][Tab][Space][LF]", [JumpNegative(1, -1, 14)])
        self.run_test("[LF][Tab][LF]", [EndSub(1, -1)])
